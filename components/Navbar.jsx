...
const Navbar = () => 

  {
    ...
    return (
        <div ref={ref} className="h-15 md:h-20 overflow-y-scroll">
            {/* <p className="w-10 h-125 "></p> */}
            <nav className={`w-full h-full sticky cursor-pointer shadow-md right-0 px-4 py-6 z-20 top-0 left-0 bg-indigo-500 flex items-center justify-between md:px-16 lg:px-24 xl:px-32 transition-all duration-500 ${isScrolled ? "bg-white/80 shadow-md text-gray-700 backdrop-blur-lg py-3 md:py-4" : "py-4 md:py-6"}`}>
...
//   return (
//     <div className='w-full h-16 sticky cursor-pointer shadow-md top-0 right-0 left-0 px-4 py-6 z-100 bg-indigo-600'>
//     </div>
//   )
// }
